...
DROP TABLE IF EXISTS FIN_TRADE_EXTRACT.RAW.EARNINGS_CALL_TRANSCRIPT;
CREATE TABLE FIN_TRADE_EXTRACT.RAW.EARNINGS_CALL_TRANSCRIPT (
...
-- Create a normalized table for split-out fields
CREATE OR REPLACE TABLE FIN_TRADE_EXTRACT.RAW.EARNINGS_CALL_TRANSCRIPT_SPLIT AS
SELECT
...
FROM (
    SELECT TRANSCRIPT_DATA AS tdata FROM FIN_TRADE_EXTRACT.RAW.EARNINGS_CALL_TRANSCRIPT
)
