...
-- IMPORTANT: Only create if not exists - DO NOT DROP on every run (preserves historical data)
-- DROP TABLE IF EXISTS FIN_TRADE_EXTRACT.RAW.TIME_SERIES_DAILY_ADJUSTED;  -- COMMENTED OUT - Would delete all data!
