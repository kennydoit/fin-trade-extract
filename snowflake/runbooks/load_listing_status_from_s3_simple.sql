...
-- Use ACCOUNTADMIN to create/grant on table if needed
...
-- 2) Create table if needed (with proper ownership)
...
-- Grant privileges to ETL_ROLE
GRANT ALL PRIVILEGES ON TABLE FIN_TRADE_EXTRACT.RAW.LISTING_STATUS TO ROLE ETL_ROLE;
GRANT USAGE ON STAGE FIN_TRADE_EXTRACT.RAW.LISTING_STATUS_STAGE TO ROLE ETL_ROLE;

-- Switch to ETL_ROLE for all data operations
USE ROLE ETL_ROLE;
