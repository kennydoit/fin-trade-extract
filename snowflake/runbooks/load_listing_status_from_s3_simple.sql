...
-- 2) Drop old table if it exists with wrong ownership, then recreate
DROP TABLE IF EXISTS FIN_TRADE_EXTRACT.RAW.LISTING_STATUS;

CREATE TABLE FIN_TRADE_EXTRACT.RAW.LISTING_STATUS (
