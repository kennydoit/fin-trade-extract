...
CREATE OR REPLACE TRANSIENT TABLE FIN_TRADE_EXTRACT.RAW.LISTING_STATUS_STAGING AS
SELECT *, CAST(NULL AS DATE) AS load_date FROM FIN_TRADE_EXTRACT.RAW.LISTING_STATUS WHERE 1=0;
