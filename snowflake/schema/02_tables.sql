...
CREATE OR REPLACE TABLE OVERVIEW (
    ...
    CONSTRAINT FK_OVERVIEW_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID)
)
...
CREATE OR REPLACE TABLE INCOME_STATEMENT (
    ...
    -- Constraints
    CONSTRAINT CK_INCOME_STATEMENT_REPORT_TYPE CHECK (REPORT_TYPE IN ('annual', 'quarterly')),
    CONSTRAINT FK_INCOME_STATEMENT_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID)
)
...
CREATE OR REPLACE TABLE BALANCE_SHEET (
    ...
    -- Constraints
    CONSTRAINT CK_BALANCE_SHEET_REPORT_TYPE CHECK (REPORT_TYPE IN ('annual', 'quarterly')),
    CONSTRAINT FK_BALANCE_SHEET_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID)
)
...
CREATE OR REPLACE TABLE CASH_FLOW (
    ...
    -- Constraints
    CONSTRAINT CK_CASH_FLOW_REPORT_TYPE CHECK (REPORT_TYPE IN ('annual', 'quarterly')),
    CONSTRAINT FK_CASH_FLOW_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID)
)
...
CREATE OR REPLACE TABLE TIME_SERIES_DAILY_ADJUSTED (
    ...
    CONSTRAINT FK_TIME_SERIES_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID)
)
...
CREATE OR REPLACE TABLE COMMODITIES (
    ...
    -- Constraints
    CONSTRAINT CK_COMMODITIES_INTERVAL CHECK (INTERVAL IN ('daily', 'monthly')),
...
CREATE OR REPLACE TABLE ECONOMIC_INDICATORS (
    ...
    -- Constraints
    CONSTRAINT CK_ECONOMIC_INDICATORS_INTERVAL CHECK (INTERVAL IN ('daily', 'monthly', 'quarterly')),
...
CREATE OR REPLACE TABLE INSIDER_TRANSACTIONS (
    ...
    -- Constraints
    CONSTRAINT CK_INSIDER_TRANSACTIONS_ACQDIS CHECK (ACQUISITION_OR_DISPOSAL IN ('A', 'D')),
    CONSTRAINT FK_INSIDER_TRANSACTIONS_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID),
...
CREATE OR REPLACE TABLE EARNINGS_CALL_TRANSCRIPTS (
    ...
    -- Constraints
    CONSTRAINT FK_EARNINGS_CALL_TRANSCRIPTS_SYMBOL_ID FOREIGN KEY (SYMBOL_ID) REFERENCES LISTING_STATUS(SYMBOL_ID),
