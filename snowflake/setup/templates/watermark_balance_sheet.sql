-- ============================================================================
-- Initialize ETL Watermarks for Balance Sheet Data
-- 
...
-- Insert watermark records for all active stocks not already tracked for BALANCE_SHEET
...
SELECT 
    '✅ Balance Sheet Watermarks Created' as status,
...
SELECT '
====================================================================
BALANCE_SHEET WATERMARKS INITIALIZED

Next steps:
1. Run the GitHub Actions workflow:
   .github/workflows/balance_sheet_watermark_etl.yml
